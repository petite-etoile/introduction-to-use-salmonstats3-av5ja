export declare namespace WeaponInfoMain {
    enum Id {
        Dummy = -999,
        RandomGold = -2,
        RandomGreen = -1,
 ...
 * @returns
 */
export declare function hash(id: WeaponInfoMain.Id | number): WeaponInfoMain.Hash;
/**
 * HashからIDを計算する
 * @param hash
 * @returns
 */
export declare function id(hash: WeaponInfoMain.Hash | string): number;
